# Generated by Django 2.0.2 on 2018-02-09 04:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='描述')),
                ('meta_keywords', models.CharField(help_text='meta 关键词标签，用逗号分隔', max_length=255, verbose_name='Meta 关键词')),
                ('meta_description', models.CharField(help_text='meta描述标签', max_length=255, verbose_name='Meta 描述')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
